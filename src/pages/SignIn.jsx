...
function SignIn({ onHome }) {
  ...
  return <div className="app sign-in-app">
    <Header activePage="signin" onHome={onHome} />
    <main className="sign-in-page">
      <section className="sign-in-card"><div className="sign-in-image">
